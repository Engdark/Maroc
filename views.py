...
def send_views():
    ...
    headers = {
        ...
        "User-Agent": f"Mozilla/5.0 (Linux; Android {random_text_number}; K) AppleWebKit/537.36 (KHTML, like {random_text_number}) Chrome/132.0.0.0 Mobile Safari/{random_text_number}",
